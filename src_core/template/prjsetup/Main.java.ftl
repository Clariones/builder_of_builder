...
public class Main {
	...
	public static String INPUT_MODEL_FOLDER = "${prjFolder}/web-code-generator/sky";
	...
	public static String OUTPUT_JAVA_FOLDER = "${prjFolder}/${prjName?lower_case}-biz-suite/bizcore/WEB-INF"; //
	// 生成的 page_flow 相关java源代码的(项目中)根目录, 通常指向 OUTPUT_JAVA_FOLDER 下的 xxx_custom_src. 因为项目迭代的关系,也可能需要额外指定目录
	public static String OUTPUT_PAGEFLOW_FOLDER_NAME = "${prjName?lower_case}_client_src";
	// 生成目标项目的 项目名, 通常与模型文件的项目名一致
	public static String TARGET_PROJECT_NAME = "${prjName}";
	// 生成目标项目的 组织名, 通常与模型文件的组织名一致
	public static String TARGET_ORGANIZATION_NAME = "${orgName}";
	...
	public static String TARGET_PAGEFLOW_JAVA_PARENT_CLASS_FULL_NAME = "com.${orgName}.${prjName}.wxappclient.WxappCustomService";
